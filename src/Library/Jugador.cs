...
public class Jugador
{
    ...
    public void CrearUnidad(IEstructuras estructuraUnidades, Celda celdaUnidad)
    {
        if (LimitePoblacion < 50 && CantidadUnidades < 30 && celdaUnidad.EstaLibre())
        {
            ...
            {
                if (unidadEspecial is Elefante || unidadEspecial is JulioCesar || unidadEspecial is Samurai ||
                    unidadEspecial is Thor)
                {
            ...
            else if (estructuraUnidades is CastilloIndio && noHayUnidadEspecial)
            {
                ...
                if (oroTotal >= recursosElefante.CostoOro && alimentoTotal >= recursosElefante.CostoAlimento &&
                    maderaTotal >= recursosElefante.CostoMadera)
                {
            ...
            else if (estructuraUnidades is CastilloVikingo && noHayUnidadEspecial)
            {
                ...
                // Verificar si tiene recursos suficientes
                if (oroTotal >= recursosThor.CostoOro && alimentoTotal >= recursosThor.CostoAlimento &&
                    maderaTotal >= recursosThor.CostoMadera)
                {
            ...
            else if (estructuraUnidades is Establo)
            {
                ...
                // Verificar si tiene recursos suficientes
                if (oroTotal >= recursosCaballeria.CostoOro && alimentoTotal >= recursosCaballeria.CostoAlimento &&
                    maderaTotal >= recursosCaballeria.CostoMadera)
                {
